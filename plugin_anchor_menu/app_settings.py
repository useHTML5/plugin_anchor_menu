...
# Used templates:
ANCHOR_MENU_TEMPLATE_ANCHOR = getattr(settings, "ANCHOR_MENU_TEMPLATE_ANCHOR", "plugin_anchor_menu/anchor.html")
ANCHOR_MENU_TEMPLATE_MENU = getattr(settings, "ANCHOR_MENU_TEMPLATE_MENU", "plugin_anchor_menu/menu.html")
...
# The id for <select> in templates/plugin_anchor_menu/menu.html
ANCHOR_MENU_DEFAULT_ID = getattr(settings, "ANCHOR_MENU_DEFAULT_ID", "plugin_anchor_menu")
